<div class="userBars index">
	<h2><?php echo __('User Bars'); ?></h2>
	...
	<?php foreach ($userBars as $userBar): ?>
	<tr>
		<td><?php echo h($userBar['UserBar']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $userBar['UserBar']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $userBar['UserBar']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userBar['UserBar']['id']), null, __('Are you sure you want to delete # %s?', $userBar['UserBar']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
